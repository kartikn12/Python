movie = {}
price = {'gold': 200, 'silver': 350, 'platinum': 550}
    ...
    while True:
        ...
        try:
            if a_choice == 1:
                ...
                silver_n = int(input("Enter silver seat:"))
                platinum_n = int(input("Enter platinum seat:"))

                movie[movies_name]['seat']['gold'] = [i for i in range(1, gold_n + 1)]
                movie[movies_name]['seat']['silver'] = [i for i in range(1, silver_n + 1)]
                movie[movies_name]['seat']['platinum'] = [i for i in range(1, platinum_n + 1)]
                print(movie)
    ...
    while True:
        ...
        try:
            ...
            if c_choice == 2:
                ...
                if movies_name in movie:
                    ticket = input("Enter your seat type for booking(gold/silver/platinum):").lower()
